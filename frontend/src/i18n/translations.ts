...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    quizEditor_timeHint: 'Time is shown in 12-hour (AM/PM) format. Use the dropdown to select AM or PM.',
    ...
    qe_correctAnswer: 'Correct Answer',
    qe_markCorrect: 'Mark Correct',
    qe_cancel: 'Cancel',
    qe_saving: 'Saving...',
    qe_update: 'Update',
    qe_add: 'Add',
  ...
  ar: {
    ...
    quizEditor_timeHint: 'الوقت يُظهر بتنسيق 12 ساعة (ص/م). استخدم القائمة المنسدلة لاختيار صباحًا أو مساءً.',
    ...
    qe_correctAnswer: 'الإجابة الصحيحة',
    qe_markCorrect: 'وضع علامة صحيح',
    qe_cancel: 'إلغاء',
